<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChatPage.aspx.cs" Inherits="Web.ChatPage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Epione : Chat Page</title>
...
<script src="Scripts/emojionearea.js"></script>
 ...
 <script type="text/javascript">
        ...
        function registerClientMethods(chatHub) {
            ...
            chatHub.client.messageReceived = function (userName, message, time, userimg) {
                ...
                if (CurrUser1 != userName) {
                    ...
                    IntervalVal = setInterval("ShowTitleAlert('Epione Chat App', '" + Notification + "')", 800);
        ...
        function GetCurrentDateTime(now) {
            ...
            var localdate = dateFormat(now, "dddd, mmmm dS, yyyy, h:MM:ss");
        ...
        <div class="content-wrapper">
            ...
            <header class="main-header" style="background: #bedaeb">
                ...
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>Epione</b> Chat App</span>
                </a>
